.. Hotspot documentation master file, created by
   sphinx-quickstart on Fri Jan 17 23:37:17 2020.
...
Hotspot is installed directly fro mthe git repository using the
following command:
...
Correlation modules can be visualized by running
``hs.plot_local_correlations()``:

.. image:: _static/corr_plot.png
   :width: 500px
   :alt: Local Correlation Plot
...
The output is a pandas DataFrame (cells x modules) and is also saved in
``hs.module_scores``
...
2019 <https://www.ncbi.nlm.nih.gov/pubmed/30923225>`__) this looks like:
